<?php
	...
	if(isset($_REQUEST['submit']))
	{
		...
		if(isset($_SESSION['admin']))
				{
					$qry1=mysqli_query($conn,"INSERT INTO otherevent(img,nm,price)VALUES('$fnm','$nm',$pr)");
					if($qry1)
					{
        ...
        <div class="grid_3 grid_4">
            <div class="tab-content">
                ...
                <div class="contact-w3form" align="center">
                    <input type="submit" name="submit" class="btn" value="SEND"> <input type="button" value="DISPLAY"
                        class="btn my" onClick="javascript:location.href='other_disp.php'" />
                </div>
                </form>
            </div>
        </div>
